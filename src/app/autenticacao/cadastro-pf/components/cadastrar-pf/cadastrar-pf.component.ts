...
export class CadastrarPfComponent implements OnInit {
  ...
  constructor(
  	private fb: FormBuilder,                       // para o formgroup
  	private snackBar: MatSnackBar,                 // para exibir as mensagens
    private router: Router,                        // para o roteamento
